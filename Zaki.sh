...
clear
   ...
   echo
   echo -e $kuning" ╔═══════════════════════════════════════════════╗"
   echo -e $kuning" ║"   "\033[34mAuther    : Zakii         
   "$kuning"    ║"
   echo -e $kuning" ║"   "\033[34mTeam      : Zakii Knight                   "$kuning"    ║"
   echo -e $kuning" ║"   "\033[34mChanel YT : 089686210527                       "$kuning"    ║"
   echo -e $kuning" ║"   "\033[34mGithub    : https://github.com/Zaki26    "$kuning"    ║"
   echo -e $kuning" ╚═══════════════════════════════════════════════╝"
